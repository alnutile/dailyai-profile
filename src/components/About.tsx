    ...
    <div className="py-12 sm:py-20 bg-white" id="about">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6">
          <h3 className="text-3xl sm:text-4xl font-bold text-center lg:text-left text-custom-pink">
          ...
          <div className="space-y-4 text-base sm:text-lg">
            <p>
              <a href="https://youtube.com/@alfrednutile?si=M6jhYvFWK1YI1hK9" target="_blank" rel="noopener" className="text-custom-pink hover:underline">
                Take a look at my YouTube channel
              </a>
              {" "}where you'll see lots of examples of using automation and AI.
            </p>
            <p>
              <a href="https://leanpub.com/php_and_llms" target="_blank" rel="noopener" className="text-custom-pink hover:underline">
                Buy my BOOK, "PHP and LLMs"
              </a>
              , where we explore the world of PHP, Laravel and AI Automations in day-to-day practical use.
            </p>
            <p>
              <a href="https://sundance-solutions.mailcoach.app/larallama-app" target="_blank" rel="noopener" className="text-custom-pink hover:underline">
                Sign up for my newsletter
              </a>
              , or have a{" "}
              <a href="https://medium.com/@alnutile" target="_blank" rel="noopener" className="text-custom-pink hover:underline">
          ...
          <div className="text-center sm:text-left">
            <button className="bg-custom-pink text-white px-6 py-3 rounded-md hover:bg-opacity-90 transition-colors">
              Learn more about me
            </button>
          </div>
        </div>
